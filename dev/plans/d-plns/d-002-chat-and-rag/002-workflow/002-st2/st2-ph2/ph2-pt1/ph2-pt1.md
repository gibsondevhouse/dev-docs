# Stage 2 / Phase 2 / Part 1 — InputBar Component
...
Create the `InputBar` component: a multi-line textarea with a Send button. Enter sends; Shift+Enter inserts a newline. The component accepts `onSend` and `disabled` props.
...
- Do not modify `ChatView` yet — the input placeholder is replaced in PT2
...
- [ ] `src/components/chat/InputBar.tsx` exists and compiles
